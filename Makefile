...
# Project:  clickcoin-qt.pro
# Template: app
# Command: /opt/local/bin/qmake USE_UPNP=- -o Makefile clickcoin-qt.pro
#############################################################################
...
Makefile: clickcoin-qt.pro  /opt/local/share/qt4/mkspecs/macx-g++/qmake.conf /opt/local/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile clickcoin-qt.pro
...
/Users/eze/clickcoin/build/build.h: FORCE
	cd /Users/eze/clickcoin; /bin/sh share/genbuild.sh /Users/eze/clickcoin/build/build.h
