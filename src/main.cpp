...
uint256 hashGenesisBlock("0xda00603a3ac533badec4e352f67d9bb547b505292cb1b8a9f696447446a5a277");
...
static const int64 nTargetTimespan = 60 * 60; // NyanCoin: 3 hours
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x38bca2e951abf00bbbb4ab149369bfe0c592c2e9beecd0afd26995852fcfd063");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Clickcoin March 2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1395666738; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 19954;

        if (fTestNet)
        {
            block.nTime    = 1395634970;
            block.nNonce   = 864333;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xa08cc3d31cc447fc664d44de38772e96febb985b77db6cb7089b5d3eb7d36eed"));
